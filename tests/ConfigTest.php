...
class ConfigTest extends TestCase
{
     ...
     */
    #[Test]
    #[TestDox('Tests retrieval of configuration values using dot notation.

    This test verifies that the `Config` class correctly retrieves nested configuration
    values specified using dot notation.
    ')]
    public function getConfigValueWithDotNotation(): void
    {
        $mockConfig = [
            'database' => [
                'sqlite' => [
     ...
     */
    #[Test]
    #[TestDox('Tests retrieval of configuration values with a default value.

    This test checks if the `Config` class returns the default value when the requested
    configuration key is not found.
    ')]
    public function getConfigValueWithDefault(): void
    {
        $mockConfig = [
            'database' => [
                'sqlite' => [
     ...
     */
    #[Test]
    #[TestDox('Tests the private method `withDots` using reflection.
    
    This test ensures that the `withDots` method, which is used to retrieve nested configuration
    values, works correctly. The method is accessed using reflection.
    ')]
    public function privateMethodWithDots(): void
    {
        $mockConfig = [
            'database' => [
                'mysql' => [
     ...
     */
    #[Test]
    #[TestDox('Tests the private method `loadConfigFile` using reflection.
    
    This test verifies that the `loadConfigFile` method correctly loads configuration data from
    a file. The method is accessed and tested using reflection.
    ')]
    public function privateMethodLoadConfigFile(): void
    {
        $mockConfig = [
            'database' => [
                'sqlite' => [
